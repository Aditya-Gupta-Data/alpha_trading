...
| `hypotheses.md` | The owner's trading theses in one register (H1 leader→laggard lead, H2 distribution→drawdown, H3 calendar-cycle confidence, H4 asymmetric add-winners/trim-losers) with how each gets harness-tested | H4 registered 2026-07-15 — simulator experiment first, not built | A hypothesis is a claim awaiting the harness, never a hand-wired rule (#63/#44/#50); H4's whole test hinges on "continuation = price confirmation, NOT signal repetition" |
