...
MIN_CONTEXT_FRAMES = 40      # the depth floor (the panel rule as a number)
# 60 -> 50 -> 40 on 2026-08-16 by owner executive override (#87, #88): force the
# first miner pass this week (VM held 38 frames on 08-16 -> wakes ~08-18/19).
...
def depth_reason(depth: dict) -> str:
    ...
    Two different sentences on purpose. `25/40 frames` alone reads the same
